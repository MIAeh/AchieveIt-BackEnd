...
@WebFilter(
        ...
        urlPatterns = {
                ...
                "/risk/addRisk",
                "/risk/updateRiskByRiskID",
                "/risk/deleteRisk",
                "/risk/changeRiskStatus",
                "/risk/addRiskHoldersByRiskId",
                "/risk/addRiskTemplate",
                "/risk/solveRisk",
                "/feature/addTopFeature",
                "/feature/addSubFeature",
                "/feature/deleteFeatureByFeatureID",
                "/feature/updateFeatureByFeatureID",
                "/feature/uploadFeatureList",
